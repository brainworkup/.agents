...
description: Use when users need public database lookups or cross-referencing across science, biomedicine, materials, clinical, regulatory, economics, finance, demographics, astronomy, earth science, or weather data; when they mention specific databases; or when they request compounds, drugs, genes, proteins, pathways, variants, trials, patents, filings, time series, structures, sequences, or affinities.
metadata:
